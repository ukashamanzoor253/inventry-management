...
// Fixed OrderPDF interface - items should be OrderItem[], not Product
interface OrderPDF {
  orderNumber: string;
  supplier: Supplier;
...
export default function CreateOrderPage() {
  ...
  const instance = (html2pdf.default || html2pdf) as any; 
  ...
  const handleSubmit = async (status: "draft" | "pending") => {
    ...
    try {
      ...
      // Create a fallback supplier object if selectedSupplier is undefined
      ...
      if (orderType === "shop") {
        const neworder: OrderPDF = {
          ...
          items: items, // items is already OrderItem[]
