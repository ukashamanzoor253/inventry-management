...
export default function SettingsPage() {
    return (
        <section className="rounded-[32px] border border-slate-200 bg-white p-6  ring-1 ring-slate-200">
            ...
            <div className="mt-6 grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
                <article className="rounded-[28px] bg-slate-50 p-5  ring-1 ring-slate-200">
